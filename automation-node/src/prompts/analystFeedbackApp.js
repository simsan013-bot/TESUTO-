// apps/analyst-feedback-app/Prompts.gs を一字一句そのまま移植（GAS API呼び出しなしの純粋な文字列生成関数のため無改修コピー）。
...
// apps/analyst-feedback-app/Config.gs のDEFAULT_ANALYST_PERSONASを一字一句そのまま移植。
...
module.exports = { buildCommonRules_, STEP_NAMES_AND_MIN_CHARS, buildPersonaSystemPrompt, buildPersonaUserPrompt, buildIntegrateSystemPrompt, buildIntegrateUserPrompt, buildRevisionSystemPrompt, buildRevisionUserPrompt, countEffective_, DEFAULT_ANALYST_PERSONAS };
