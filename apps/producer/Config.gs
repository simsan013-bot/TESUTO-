...
var CONFIG_KEYS = {
  ...
  ANALYST_FEEDBACK_APP_URL: 'ANALYST_FEEDBACK_APP_URL',
  ANALYST_FEEDBACK_APP_KEY: 'ANALYST_FEEDBACK_APP_KEY',
  ...
  CAT_COMMENTARY_APP_URL: 'CAT_COMMENTARY_APP_URL',
  CAT_COMMENTARY_APP_KEY: 'CAT_COMMENTARY_APP_KEY',
